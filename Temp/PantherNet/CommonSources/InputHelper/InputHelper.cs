...
namespace Examples.Classes
{
    public class InputHelper
    {
        ...
        {
            get { return endDragPos - startDragPos; }
        }
        ...
        {
            return startDragPos != Vector2.Zero;
        }
        ...
        public Vector2 GetMouseDragVector(float limit = 35f)
        {
            ...
            if (absx > absy)
            {
                if (absx > limit) return new Vector2(src.X, 0);
                else return Vector2.Zero;
            }
            else if (absy > limit) return new Vector2(0, src.Y);
            else return Vector2.Zero;
        }
        ...
        {
            return MouseState.ScrollWheelValue - PrevScrollWheelValue;
        }
        ...
        internal void Update(GameTime gameTime)
        {
            ...
            PrevScrollWheelValue = MouseState == null ? 0 : MouseState.ScrollWheelValue;
            MouseState = Mouse.GetState();
            if (MouseState.LeftButton == ButtonState.Pressed && LastMouseState.LeftButton == ButtonState.Released)
                endDragPos = startDragPos = new Vector2(MouseState.X, MouseState.Y);
            if (MouseState.LeftButton == ButtonState.Pressed && LastMouseState.LeftButton == ButtonState.Pressed)
                endDragPos = new Vector2(MouseState.X, MouseState.Y);
            if (MouseState.LeftButton == ButtonState.Released && LastMouseState.LeftButton == ButtonState.Pressed)
                startDragPos = endDragPos = Vector2.Zero;
