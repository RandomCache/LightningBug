...
namespace Examples.UIDesigner
{
    ...
    public class MainGame : Game
    {
        ...
        private const int VirtualResolutionWidth = 1280;
        private const int VirtualResolutionHeight = 720;
        ...
        protected override void LoadContent()
        {
            ...
            var _playTexture = Content.Load<Texture2D>("play.png");
            var _optTexture = Content.Load<Texture2D>("options.png");
            var _quitTexture = Content.Load<Texture2D>("quit.png");
            ...
            {
                new UIDesignerComponent.MyTuple<Texture2D, Rectangle, string>(_playTexture,  new Rectangle(0,636,205,51), "Play"),
                new UIDesignerComponent.MyTuple<Texture2D, Rectangle, string>(_optTexture,  new Rectangle(1065,631,191,51), "Options"),
                new UIDesignerComponent.MyTuple<Texture2D, Rectangle, string>(_quitTexture,  new Rectangle(1025,21,247,65), "Quit"),
